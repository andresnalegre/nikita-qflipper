@echo off
rem Full build + windeployqt bundle + NSIS installer. Predates the Nikita fork;
rem only the stale Application->application path was fixed here, and it hasn't
rem been re-tested end to end (no Windows/MSVC box available to run it on).
