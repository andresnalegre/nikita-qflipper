...
#include "toplevel/rebootoperation.h"
#include "toplevel/formatstorageoperation.h"
...
void FlipperZero::rebootDevice()
{
    registerOperation(new RebootOperation(m_utility, m_state, this));
}

void FlipperZero::formatExternalStorage()
{
    registerOperation(new FormatStorageOperation(m_utility, m_state, this));
}
